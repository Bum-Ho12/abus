// lib/adapters/provider_adapter.dart
...
class ProviderAdapter<T extends ChangeNotifier> extends StateAdapter {
  final T provider;
  final String Function(InteractionDefinition) _idExtractor;
  final bool Function(InteractionDefinition) _canHandleChecker;
  final Future<void> Function(
          T provider, String id, InteractionDefinition interaction)
      _optimisticHandler;
  final Future<void> Function(
          T provider, String id, InteractionDefinition interaction)
      _rollbackHandler;
  final Future<void> Function(
      T provider, String id, InteractionDefinition interaction) _commitHandler;
  ...
  @override
  String get name => 'ProviderAdapter<${T.toString()}>';
  ...
  Future<void> updateOptimistic(
    ...
    return _optimisticHandler(provider, id, interaction);
  }
  ...
  Future<void> rollback(
      String interactionId, InteractionDefinition interaction) {
    final id = _idExtractor(interaction);
    return _rollbackHandler(provider, id, interaction);
  }

  @override
  Future<void> commit(String interactionId, InteractionDefinition interaction) {
    final id = _idExtractor(interaction);
    return _commitHandler(provider, id, interaction);
  }
